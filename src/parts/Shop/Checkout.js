...
export default function Checkout(props) {
   ...
   const totalPrice = useMemo(() => {
      return Object.values(props.data.productsOrdered).reduce(
         (acc, product) => {
      ...
      >
         <div className="flex flex-col">
            {isLoadingData ? (
               ...
               <div className="mb-2">
                  <Button
                     ...
                     disableElevation
                     startIcon={
                        props.statusOrder.isCreateOrder || <LocalMall />
                     }
                     onClick={() => {
                     ...
                     disabled={
                        props.data.name === '' ||
                        Object.values(props.data.productsOrdered).length ===
                           0 ||
                        props.statusOrder.isCreateOrder
                     }
                  >
                     {props.statusOrder.isCreateOrder ? (
                        ...
                        `${props.lang?.btn__checkout_now || 'Checkout Now'}${
            ...
            <div>
               <WhatsappButton
                  ...
                  onClick={() => {
                     ...
                     !props.statusOrder.isCreateOrderViaWA &&
                        props.fnCreateOrder(isOrderViaWa)
                  }}
                  disabled={
                     props.data.name === '' ||
                     (!whitelistFeatures?.['catalog_wacommerce'] &&
               ...
               >
                  {whitelistFeatures?.['white_label_wa_commerce']
                     ? props.lang?.btn__order_now || 'Order Now'
                     : props.lang?.btn__order_via_whatsapp ||
                       'Order via WhatsApp'}
               </WhatsappButton>
            </div>
         </div>
